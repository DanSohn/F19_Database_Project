...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2019 at 07:56 PM
...
--
CREATE DATABASE IF NOT EXISTS `order tracker` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `order tracker`;
...
INSERT INTO `person` (`SIN`, `FName`, `MName`, `LName`, `PhoneNumber`, `Email`, `Address`, `City`, `PostalCode`, `Password`, `PersonType`) VALUES
...
('root', '[{\"db\":\"order tracker\",\"table\":\"person\"},{\"db\":\"order tracker\",\"table\":\"Person\"}]');
...
('root', '2019-11-20 18:56:01', '{\"Console\\/Mode\":\"collapse\"}');
